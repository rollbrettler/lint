...
const (
	...
	Whatsit = "missing_comment" // MATCH /Whatsit.*should have a comment.*block/
...
const UndocAgain = 6 // MATCH /UndocAgain.*should have a comment/

const (
	SomeUndocumented = 7 // MATCH /SomeUndocumented.*should have a comment.*block/
)
